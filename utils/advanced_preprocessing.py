...
class AdvancedFracturePreprocessor:
    ...
    def sanitize_and_balance(self, img_np):
        """Step 1 & 2: Deterministic Sanitization (AutoCrop) + CLAHE Balancing"""
        # Ensure uint8
        ...
        # 2. Localized Illumination via CLAHE
    ...
    def __call__(self, pil_img):
        ...
        ch_r = balanced
        ch_g = self.wavelet_detail_boost(balanced) if self.apply_wavelet else balanced
